...
# def train_opponent(name, opponent_path, num_episodes=2000, lr=1e-4, gamma=0.99):
#     env = FootballMultiAgentEnv()
...
if __name__ == "__main__":
    train_opponent(
        name='red_league_new',
        opponent_path="../checkpoints/league_new/kick_football_episode_1800_2.pth",
        num_episodes=100000)
